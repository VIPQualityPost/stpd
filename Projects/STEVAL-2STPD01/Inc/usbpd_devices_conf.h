...
#else
/* Inverted instance to allow DRP on instance 2 for verification */
/* defined used to configure function : USBPD_HW_GetUSPDInstance */
#define UCPD_INSTANCE0 UCPD2
#define UCPD_INSTANCE1 UCPD1
...
#define UCPDDMA_INSTANCE1_REQUEST_RX   DMA_REQUEST_UCPD1_RX
...
#define UCPDDMA_INSTANCE1_REQUEST_TX   DMA_REQUEST_UCPD1_TX
